...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 也不支持倒影效果，绘制有问题.
        // 请大家不要按照我这样写.
        // 如果你不想放大 小人超出边框(demo，张靓颖的小人)，可以不使用OpenEffectBridge.
        ...
        findViewById(R.id.two_recyclerview).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.effect_rlay:
                ...
                switchNoDrawBridgeVersion();
                break;
            case R.id.two_recyclerview: // 菜单测试.
                showMsg("two_recyclerview");
                startActivity(new Intent(getApplicationContext(), DemoTwoRecyclerViewActivity.class));
                break;
