...
public class ListViewHorizontal extends AdapterView<ListAdapter> {
	ScaleAnimation scaleAnimation = new ScaleAnimation(1.22f, 0.9f, 1.22f, 0.9f,
			Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
	ScaleAnimation scaleAnimation1 = new ScaleAnimation(1, 1.2f, 1, 1.2f,
			Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    private static final String TAG = "ListViewHorizontal";
    ...
    public ListViewHorizontal(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ListViewHorizontalStyle);
    }

    public ListViewHorizontal(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ListViewHorizontal, defStyleAttr, 0);
        mItemWidth = ta.getDimensionPixelSize(R.styleable.ListViewHorizontal_item_width, 200);
        mItemHeight = ta.getDimensionPixelSize(R.styleable.ListViewHorizontal_item_height, 200);
        mItemScaleFactor = ta.getFloat(R.styleable.ListViewHorizontal_item_scale_factor, 1.5f);
        mItemScaleDuration = ta.getInteger(R.styleable.ListViewHorizontal_item_scale_duration, 300);
        mSpacing = ta.getDimensionPixelOffset(R.styleable.ListViewHorizontal_spacing, 20);
        mLeftOffSet = ta.getDimensionPixelOffset(R.styleable.ListViewHorizontal_left_offset, 20);
        mRightOffSet = ta.getDimensionPixelOffset(R.styleable.ListViewHorizontal_right_offset, 20);
        mGravity = ta.getInt(R.styleable.ListViewHorizontal_gravity, 1);
        int color = ta.getColor(R.styleable.ListViewHorizontal_bg_color, 0x80ffffff);
        ta.recycle();
