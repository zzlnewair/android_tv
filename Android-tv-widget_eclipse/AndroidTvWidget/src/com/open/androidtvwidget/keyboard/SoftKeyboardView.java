...
public class SoftKeyboardView extends View {
    ...
    public boolean moveToNextKey(int direction) {
        ...
        if (softKey != null) {
            ...
            if (mOnKeyBoardAnimListener != null) {
                if (mOnKeyBoardAnimListener.onKeyBoardAnim(this, oldsoftkey, softKey)) {
                    return true;
                }
            }
            if (!mIsMoveRect) {
    ...
    private void setMoveSoftKeyAnimation(final SoftKey oldSoftkey, final SoftKey targetSoftKey) {
        ...
        scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float left = (float) animation.getAnimatedValue("Left");// java 1.7 
