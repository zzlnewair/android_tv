...
public class SoftKey {
    ...
    public void setWidth(float width) {
        float bettW = (float) (width - getWidth());
        mMoveLeftF = mLeftF - bettW;
        mMoveRightF = mRightF + bettW;
    }
    ...
    public void setHeight(float height) {
        float bettH = (float) (height - getHeight());
        mMoveTopF = mTopF - bettH;
        mMoveBottomF = mBottomF + bettH;
    }
