...
public abstract class TvLayoutManager extends LayoutManager {
    private static final String LOGTAG = TvLayoutManager.class.getSimpleName();
    ...
    public TvLayoutManager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TvLayoutManager(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a =
    ...
    public TvLayoutManager(Orientation orientation) {
