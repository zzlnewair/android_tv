package com.zzl.view.recyclerview;
...
import com.zzl.view.recyclerview.impl.PrvInterface;
...
//        return cannotScrollBackward(value) || cannotScrollForward(value);
    ...
    private boolean isVertical() {
       ...
       // return layout.getOrientation() == LinearLayoutManager.VERTICAL;
    	 ...
    	 return (isHorizontalLayoutManger()==false);
    }
    ...
    private boolean isHorizontalLayoutManger() {
        ...
        if (lm != null) {
            ...
            if (lm instanceof GridLayoutManager) {
                ...
                return StaggeredGridLayoutManager.HORIZONTAL == glm.getOrientation();
            }
        }
        return false;
    }
